...
<div>
    <h3>
        Добро пожаловать в систему ISManager, ${loggedInUsername}
    </h3>

    <p>
        Система ISManager создана для автоматизации менеджмента информационной безопасности в соответствии
