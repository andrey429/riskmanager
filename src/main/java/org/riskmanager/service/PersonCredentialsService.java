 ...
 */
@Service("personCredentialsService")
@Transactional(readOnly = true)
public class PersonCredentialsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String login)
        ...
        try {
            ...
            // Search database for a user that matches the specified login
            ...
            user =  new User(
                    ...
                    true,
                    true,
                    getAuthorities(person.getAccessLevel()));
        ...
        // We just merely retrieve a user that matches the specified login
